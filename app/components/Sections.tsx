...
export function About() {
  ...
  return (
    <section id="about" style={{ padding: '120px 5%', background: 'var(--bg)' }} className="grid-bg">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          {values.map((v, i) => (
            <div key={i} style={{
              ...
              <h4 style={{ fontSize: 15, fontWeight: 700, marginBottom: 8 }}>{v.title}</h4>
...
export function Contact() {
  return (
    <section id="contact" style={{ padding: '120px 5%', background: 'var(--surface2)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start' }} className="contact-grid">
          ...
          <div>
            ...
            {[
              ...
              { icon: <Globe size={18} color="var(--accent)" />, label: 'Website', value: 'dantechdevs.com' },
            ].map((c, i) => (
...
export function Footer() {
  return (
    <footer style={{ background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: '44px 5%' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 10, color: 'var(--muted)', letterSpacing: '0.1em' }}>IT & CONSULTANCY</div>
          </div>
        </div>
